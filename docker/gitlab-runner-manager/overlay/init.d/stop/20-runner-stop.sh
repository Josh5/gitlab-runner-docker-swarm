...
# -----
# Last Modified: Friday, 21st March 2025 6:17:40 pm
# Modified By: Josh.5 (jsunnex@gmail.com)
###

echo "--- Stopping GitLab Runner container ${gitlab_runner_name:?} ---"
docker stop --time 120 ${gitlab_runner_name:?} &>/dev/null || true
